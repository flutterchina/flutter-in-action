  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        collapsable: false,
        children:[
          ['/chapter1/mobile_development_intro','1.1：移动开发技术简介'],
          ['/chapter1/flutter_intro','1.2：初识Flutter'],
          ['/chapter1/install_flutter','1.3：搭建Flutter开发环境'],
          ['/chapter1/dart','1.4：Dart语言简介']
        ]
      },
      {
